...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_31518 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_31518(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_31519 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_31519(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_31520 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_31520(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_31521 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_31521(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_31522 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_31522(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_31525 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_31525(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_31526 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_31526(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_31527 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_31527(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_31528 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_31528(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_31529 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_31529(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k31486,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__31493 = k31486;
var G__31493__$1 = (((G__31493 instanceof cljs.core.Keyword))?G__31493.fqn:null);
switch (G__31493__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k31486,else__5346__auto__);
...
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31495,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31495,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__31485){
var self__ = this;
var G__31485__$1 = this;
return (new cljs.core.RecordIter((0),G__31485__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this31487,other31488){
var self__ = this;
var this31487__$1 = this;
return (((!((other31488 == null)))) && ((((this31487__$1.constructor === other31488.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31487__$1.status,other31488.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31487__$1.body,other31488.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31487__$1.status_text,other31488.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31487__$1.headers,other31488.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31487__$1.was_aborted,other31488.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31487__$1.__extmap,other31488.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k31486){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__31485){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__31510 = cljs.core.keyword_identical_QMARK_;
var expr__31511 = k__5352__auto__;
if(cljs.core.truth_((pred__31510.cljs$core$IFn$_invoke$arity$2 ? pred__31510.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__31511) : pred__31510.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__31511)))){
return (new ajax.protocols.Response(G__31485,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31510.cljs$core$IFn$_invoke$arity$2 ? pred__31510.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__31511) : pred__31510.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__31511)))){
return (new ajax.protocols.Response(self__.status,G__31485,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31510.cljs$core$IFn$_invoke$arity$2 ? pred__31510.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31511) : pred__31510.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31511)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__31485,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31510.cljs$core$IFn$_invoke$arity$2 ? pred__31510.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31511) : pred__31510.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31511)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__31485,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31510.cljs$core$IFn$_invoke$arity$2 ? pred__31510.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31511) : pred__31510.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31511)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__31485,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__31485),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__31485){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__31485,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__31490){
var extmap__5385__auto__ = (function (){var G__31517 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__31490,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__31490),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__31490),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__31490),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__31490),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__31490),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
