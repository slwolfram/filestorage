...
var vec__28770 = cljs.core.rest(expr);
...
var vec__28773 = first__28772;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28773,(0),null);
var form = seq__28771__$1;
...
var G__28776 = x;
var G__28776__$1 = (((G__28776 == null))?null:spec_tools.impl.polish(G__28776));
var G__28776__$2 = (((G__28776__$1 == null))?null:cljs.core.name(G__28776__$1));
if((G__28776__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__28776__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__28777 = x;
var G__28777__$1 = (((G__28777 == null))?null:cljs.core.name(G__28777));
if((G__28777__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__28777__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__28778){
var map__28779 = p__28778;
var map__28779__$1 = cljs.core.__destructure_map(map__28779);
var data = map__28779__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28779__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28779__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28779__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28779__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__28781){
var map__28782 = p__28781;
var map__28782__$1 = cljs.core.__destructure_map(map__28782);
var data = map__28782__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28782__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28782__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__28783 = data;
var G__28783__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28783,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__28783);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28783__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__28783__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__28788 = form;
var G__28788__$1 = (((G__28788 == null))?null:cljs.core.rest(G__28788));
if((G__28788__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__28788__$1);
}
})();
var G__28789 = m;
var G__28789__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28789,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__28785_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__28785_SHARP_)));
})):G__28789);
var G__28789__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28789__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__28786_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__28786_SHARP_)));
})):G__28789__$1);
var G__28789__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28789__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__28787_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__28787_SHARP_));
})):G__28789__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__28789__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__28792 = (function (){var G__28793 = form;
var G__28793__$1 = (((G__28793 == null))?null:cljs.core.rest(G__28793));
if((G__28793__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__28793__$1);
}
})();
var map__28792__$1 = cljs.core.__destructure_map(map__28792);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28792__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28792__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28792__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28792__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__28796 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__28799 = form;
var G__28799__$1 = (((G__28799 == null))?null:cljs.core.seq(G__28799));
var G__28799__$2 = (((G__28799__$1 == null))?null:cljs.core.first(G__28799__$1));
if((G__28799__$2 == null)){
return null;
} else {
var fexpr__28800 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__28800.cljs$core$IFn$_invoke$arity$1 ? fexpr__28800.cljs$core$IFn$_invoke$arity$1(G__28799__$2) : fexpr__28800.call(null,G__28799__$2));
}
})():null));
});
/**
...
var len__5769__auto___28823 = arguments.length;
var i__5770__auto___28824 = (0);
while(true){
if((i__5770__auto___28824 < len__5769__auto___28823)){
args__5775__auto__.push((arguments[i__5770__auto___28824]));

var G__28825 = (i__5770__auto___28824 + (1));
i__5770__auto___28824 = G__28825;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq28801){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__28802){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__28808){
var map__28809 = p__28808;
var map__28809__$1 = cljs.core.__destructure_map(map__28809);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28809__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28809__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28809__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28809__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__28806_SHARP_){
return cljs.core.map_QMARK_(p1__28806_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__28807_SHARP_){
return cljs.core.contains_QMARK_(p1__28807_SHARP_,x);
});
}),req_keys));
