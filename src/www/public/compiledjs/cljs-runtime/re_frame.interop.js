...
return [(function (){var pred__30434 = cljs.core.instance_QMARK_;
var expr__30435 = reactive_val;
if(cljs.core.truth_((pred__30434.cljs$core$IFn$_invoke$arity$2 ? pred__30434.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__30435) : pred__30434.call(null,reagent.ratom.RAtom,expr__30435)))){
return "ra";
} else {
if(cljs.core.truth_((pred__30434.cljs$core$IFn$_invoke$arity$2 ? pred__30434.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__30435) : pred__30434.call(null,reagent.ratom.RCursor,expr__30435)))){
return "rc";
} else {
if(cljs.core.truth_((pred__30434.cljs$core$IFn$_invoke$arity$2 ? pred__30434.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__30435) : pred__30434.call(null,reagent.ratom.Reaction,expr__30435)))){
return "rx";
} else {
if(cljs.core.truth_((pred__30434.cljs$core$IFn$_invoke$arity$2 ? pred__30434.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__30435) : pred__30434.call(null,reagent.ratom.Track,expr__30435)))){
return "tr";
} else {
return "other";
}
