...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__32522,open,xs,sep,close,f){
var map__32524 = p__32522;
var map__32524__$1 = cljs.core.__destructure_map(map__32524);
var printer = map__32524__$1;
var print_level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32524__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32524__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__32526 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__32526,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__32526;
}
})();
var xform = cljs.core.comp.cljs$core$IFn$_invoke$arity$3((cljs.core.truth_(print_length)?cljs.core.take.cljs$core$IFn$_invoke$arity$1(print_length):cljs.core.identity),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32521_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(printer__$1,p1__32521_SHARP_) : f.call(null,printer__$1,p1__32521_SHARP_));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k32532,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32532,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__32542){
var vec__32543 = p__32542;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32543,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32543,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32531){
var self__ = this;
var G__32531__$1 = this;
return (new cljs.core.RecordIter((0),G__32531__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var self__ = this;
var this$__$1 = this;
var _STAR_print_dup_STAR__orig_val__32546 = cljs.core._STAR_print_dup_STAR_;
var _STAR_print_dup_STAR__temp_val__32547 = false;
(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__temp_val__32547);
...
}finally {(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__orig_val__32546);
}}));
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto__ = (function (){var G__32548 = cljs.core.first(x);
return (self__.symbols.cljs$core$IFn$_invoke$arity$1 ? self__.symbols.cljs$core$IFn$_invoke$arity$1(G__32548) : self__.symbols.call(null,G__32548));
})();
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__32549){
var self__ = this;
var map__32550 = p__32549;
var map__32550__$1 = cljs.core.__destructure_map(map__32550);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32550__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32550__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll(this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__32551){
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__32555 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__32556 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__32556);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__32555);
}})()], null);
}));
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__32557 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__32558 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__32558);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__32557);
}})()], null);
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32533,other32534){
var self__ = this;
var this32533__$1 = this;
return (((!((other32534 == null)))) && ((((this32533__$1.constructor === other32534.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32533__$1.symbols,other32534.symbols)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32533__$1.print_meta,other32534.print_meta)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32533__$1.print_length,other32534.print_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32533__$1.print_level,other32534.print_level)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32533__$1.__extmap,other32534.__extmap)))))))))))));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k32532){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32532);

}
}));

(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__32531){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__32560 = cljs.core.keyword_identical_QMARK_;
var expr__32561 = k__5352__auto__;
if(cljs.core.truth_((pred__32560.cljs$core$IFn$_invoke$arity$2 ? pred__32560.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__32561) : pred__32560.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__32561)))){
return (new fipp.edn.EdnPrinter(G__32531,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32560.cljs$core$IFn$_invoke$arity$2 ? pred__32560.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__32561) : pred__32560.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__32561)))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__32531,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32560.cljs$core$IFn$_invoke$arity$2 ? pred__32560.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__32561) : pred__32560.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__32561)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__32531,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32560.cljs$core$IFn$_invoke$arity$2 ? pred__32560.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__32561) : pred__32560.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__32561)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__32531,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__32531),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__32531){
var self__ = this;
var this__5342__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__32531,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__32535){
var extmap__5385__auto__ = (function (){var G__32563 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32535,new cljs.core.Keyword(null,"symbols","symbols",1211743),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], 0));
if(cljs.core.record_QMARK_(G__32535)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32563);
} else {
return G__32563;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__32535),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__32535),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__32535),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__32535),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var _STAR_print_meta_STAR__orig_val__32566 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__32567 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__32567);

try{return fipp.visit.visit(printer,x);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__32566);
}}));
