...
var G__32028 = (root.arr[(slc - (1))]);
var G__32029 = (shift - (5));
var G__32030 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__32028;
shift = G__32029;
cnt = G__32030;
continue;
...
if((!(r_QMARK_))){
var rngs_32039 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_32040 = (rngs_32039[(0)]);
var new_rngs_32041 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_32042 = (rngs_32039[(32)]);
cljs.core.array_copy(rngs_32039,(1),new_rngs_32041,(0),(lim_32042 - (1)));

var i_32043 = (0);
while(true){
if((i_32043 < lim_32042)){
(new_rngs_32041[i_32043] = ((new_rngs_32041[i_32043]) - rng0_32040));
...
(new_rngs_32041[(32)] = ((rngs_32039[(32)]) - (1)));

(new_rngs_32041[((rngs_32039[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_32041);
} else {
}
...
while(true){
if((i_32045 <= li)){
(new_rngs[i_32045] = ((new_rngs[(i_32045 - (1))]) + step));

var G__32046 = (i_32045 + (1));
i_32045 = G__32046;
continue;
} else {
}
...
while(true){
if((i_32047 <= li)){
(new_rngs[i_32047] = ((rngs[i_32047]) - d));
...
while(true){
if((j_32049 <= i)){
(rngs[j_32049] = r_32050);

var G__32051 = (j_32049 + (1));
var G__32052 = (r_32050 + step);
j_32049 = G__32051;
r_32050 = G__32052;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__32021 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__32021[(0)] = node.arr.length);
...
var arr_32053__$1 = arr;
var shift_32054__$1 = shift;
while(true){
if((shift_32054__$1 === (5))){
if((!(reg_QMARK_))){
(arr_32053__$1[(32)] = rngs);
} else {
}

(arr_32053__$1[(0)] = node);
} else {
var a_32055 = (new Array(len));
var e_32056 = cljs.core.__GT_VectorNode(null,a_32055);
(arr_32053__$1[(0)] = e_32056);
...
var G__32057 = a_32055;
var G__32058 = (shift_32054__$1 - (5));
arr_32053__$1 = G__32057;
shift_32054__$1 = G__32058;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__32022 = (arr[(li - (1))]);
var G__32023 = (shift - (5));
var G__32024 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__32025 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__32022,G__32023,G__32024,G__32025) : clojure.core.rrb_vector.nodes.fold_tail.call(null,G__32022,G__32023,G__32024,G__32025));
})());
