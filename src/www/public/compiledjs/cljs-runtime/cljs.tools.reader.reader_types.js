...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27001 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27001(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27002 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27002(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27003 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27003(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27004 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27004(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27005 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27005(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27006 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27006(reader);
}
});
...
var G__27013 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27014 = s.append(c);
c = G__27013;
s = G__27014;
continue;
}
