...
var fipp$ednize$IEdn$_edn$dyn_31954 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_31954(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function fipp$ednize$edn_$_iter__31939(s__31940){
return (new cljs.core.LazySeq(null,(function (){
var s__31940__$1 = s__31940;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__31940__$1);
if(temp__5804__auto__){
var s__31940__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31940__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__31940__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__31942 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__31941 = (0);
while(true){
if((i__31941 < size__5522__auto__)){
var k = cljs.core._nth(c__5521__auto__,i__31941);
cljs.core.chunk_append(b__31942,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__31955 = (i__31941 + (1));
i__31941 = G__31955;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31942),fipp$ednize$edn_$_iter__31939(cljs.core.chunk_rest(s__31940__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31942),null);
}
} else {
var k = cljs.core.first(s__31940__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__31939(cljs.core.rest(s__31940__$2)));
}
} else {
return null;
}
