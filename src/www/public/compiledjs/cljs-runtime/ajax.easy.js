...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__31868 = cljs.core.second(format);
var G__31869 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__31868,G__31869) : ajax.easy.keyword_response_format_element.call(null,G__31868,G__31869));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31871_SHARP_){
return ajax.easy.keyword_response_format_element(p1__31871_SHARP_,format_params);
}),format));
} else {
...
var fexpr__31878_31886 = (cljs.core.truth_(ok)?h:e);
(fexpr__31878_31886.cljs$core$IFn$_invoke$arity$1 ? fexpr__31878_31886.cljs$core$IFn$_invoke$arity$1(result) : fexpr__31878_31886.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__31879){
var map__31880 = p__31879;
var map__31880__$1 = cljs.core.__destructure_map(map__31880);
var opts = map__31880__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31880__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31880__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31880__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31880__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31880__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
