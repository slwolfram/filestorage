...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__31824){
var map__31825 = p__31824;
var map__31825__$1 = cljs.core.__destructure_map(map__31825);
var request = map__31825__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31825__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__31829 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__31829.cljs$core$IFn$_invoke$arity$1 ? fexpr__31829.cljs$core$IFn$_invoke$arity$1(response) : fexpr__31829.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__31830 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__31830.cljs$core$IFn$_invoke$arity$1 ? fexpr__31830.cljs$core$IFn$_invoke$arity$1(response) : fexpr__31830.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__31831){
var map__31832 = p__31831;
var map__31832__$1 = cljs.core.__destructure_map(map__31832);
var request = map__31832__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31832__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
