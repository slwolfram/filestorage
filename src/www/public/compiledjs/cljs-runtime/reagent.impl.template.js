...
var G__25034 = o;
reagent.impl.template.goog$module$goog$object.set(G__25034,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__25071__delegate = function (args){
...
while (G__25072__i < G__25072__a.length) {G__25072__a[G__25072__i] = arguments[G__25072__i + 0]; ++G__25072__i;}
  args = new cljs.core.IndexedSeq(G__25072__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25073);
...
var vec__25044 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25044,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25044,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25044,(2),null);
...
var temp__5808__auto___25094 = reagent.impl.template.key_from_vec(v);
if((temp__5808__auto___25094 == null)){
} else {
var key_25095 = temp__5808__auto___25094;
(jsprops.key = key_25095);
}
...
var temp__5808__auto___25096 = reagent.impl.template.key_from_vec(argv);
if((temp__5808__auto___25096 == null)){
} else {
var key_25097 = temp__5808__auto___25096;
(jsprops.key = key_25097);
}
...
var G__25057 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__25057) : reagent.impl.template.as_element.call(null,G__25057));
} else {
var temp__5808__auto___25098 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5808__auto___25098 == null)){
} else {
var key_25099 = temp__5808__auto___25098;
(jsprops.key = key_25099);
}
...
var G__25059 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__25059)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25060){
var G__25061 = cljs.core.first(seq25060);
var seq25060__$1 = cljs.core.next(seq25060);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25061,seq25060__$1);
}));
...
break;
default:
var G__25104 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__25104;
continue;
...
var ctx = ({});
var vec__25067 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(1),null);
...
var G__25070 = (cljs.core.count(argv) - first_child);
switch (G__25070) {
case (0):
