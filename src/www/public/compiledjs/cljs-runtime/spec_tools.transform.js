...
if((x instanceof cljs.core.Keyword)){
var G__29034 = spec;
var G__29035 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__29036 = spec;
var G__29037 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__29036,G__29037) : f.call(null,G__29036,G__29037));
} else {
return x;
...
if(typeof x === 'number'){
var G__29038 = spec;
var G__29039 = spec_tools.transform.number__GT_string(spec,x);
...
}catch (e29040){if((e29040 instanceof Error)){
var ___$1 = e29040;
return x;
} else {
throw e29040;
...
}catch (e29041){if((e29041 instanceof Error)){
var ___$1 = e29041;
return x;
} else {
throw e29041;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__29058,x){
var map__29059 = p__29058;
var map__29059__$1 = cljs.core.__destructure_map(map__29059);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29059__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__29060,x){
var map__29061 = p__29060;
var map__29061__$1 = cljs.core.__destructure_map(map__29061);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29061__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__29062,x){
var map__29063 = p__29062;
var map__29063__$1 = cljs.core.__destructure_map(map__29063);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29063__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
