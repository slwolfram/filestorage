...
var i_16966 = (self__.level + (1));
while(true){
if((i_16966 <= (new_level + (1)))){
(update[i_16966] = self__.header);

var G__16967 = (i_16966 + (1));
i_16966 = G__16967;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16968 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16968[i]));
} else {
x__$2.forward.push((((i < links_16968.length))?(links_16968[i]):null));
}

if((i < links_16968.length)){
(links_16968[i] = x__$2);
} else {
links_16968.push(x__$2);
}
...
var i_16970 = (0);
while(true){
if((i_16970 <= self__.level)){
var links_16971 = (update[i_16970]).forward;
if((x__$1 === (((i_16970 < links_16971.length))?(links_16971[i_16970]):null))){
(links_16971[i_16970] = (x__$1.forward[i_16970]));

var G__16972 = (i_16970 + (1));
i_16970 = G__16972;
continue;
} else {
var G__16973 = (i_16970 + (1));
i_16970 = G__16973;
continue;
}
} else {
