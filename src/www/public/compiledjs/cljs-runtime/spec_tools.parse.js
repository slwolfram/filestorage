...
var fexpr__28813 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__28813.cljs$core$IFn$_invoke$arity$1 ? fexpr__28813.cljs$core$IFn$_invoke$arity$1(type) : fexpr__28813.call(null,type));
});
...
var G__28817 = spec_tools.impl.normalize_symbol(x);
var G__28818 = null;
var G__28819 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__28817,G__28818,G__28819) : spec_tools.parse.parse_form.call(null,G__28817,G__28818,G__28819));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__28820 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__28821 = x;
var G__28822 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__28820,G__28821,G__28822) : spec_tools.parse.parse_form.call(null,G__28820,G__28821,G__28822));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__29032 = cljs.spec.alpha.form(x);
var G__29033 = options;
x = G__29032;
options = G__29033;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__28829 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__28830 = null;
var G__28831 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__28829,G__28830,G__28831) : spec_tools.parse.parse_form.call(null,G__28829,G__28830,G__28831));
} else {
...
var G__28836 = parse_data;
var G__28836__$1 = (((G__28836 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__28836));
var G__28836__$2 = (((G__28836__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__28836__$1));
var G__28836__$3 = (((G__28836__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__28836__$2));
var G__28836__$4 = (((G__28836__$3 == null))?null:cljs.core.seq(G__28836__$3));
if((G__28836__$4 == null)){
return null;
} else {
return cljs.core.set(G__28836__$4);
}
}
});
...
var map__28978 = spec_tools.impl.parse_keys(form);
var map__28978__$1 = cljs.core.__destructure_map(map__28978);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28978__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28978__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28978__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28978__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28978__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__28985 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__28985__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28985,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__28985);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28985__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__28985__$1;
}
}));
...
var vec__28993 = multi_spec_form;
var seq__28994 = cljs.core.seq(vec__28993);
var first__28995 = cljs.core.first(seq__28994);
var seq__28994__$1 = cljs.core.next(seq__28994);
var _ = first__28995;
var first__28995__$1 = cljs.core.first(seq__28994__$1);
var seq__28994__$2 = cljs.core.next(seq__28994__$1);
var multi_method_symbol = first__28995__$1;
var ___$1 = seq__28994__$2;
var form = vec__28993;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__28997){
var vec__28998 = p__28997;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28998,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28998,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__29003_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__29003_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__29004_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__29004_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__29007_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__29007_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29008_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__29008_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__29009 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__29009__$1 = cljs.core.__destructure_map(map__29009);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29009__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__29012 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__29012__$1 = cljs.core.__destructure_map(map__29012);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29012__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__29013,options){
var vec__29014 = p__29013;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29014,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29014,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29014,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__29018,options){
...
var ___$1 = first__29021;
var values = seq__29020__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__29017_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__29017_SHARP_,options);
}),values);
...
var type_priority = (function (p1__29022_SHARP_){
var G__29025 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__29024 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__29022_SHARP_);
return (fexpr__29024.cljs$core$IFn$_invoke$arity$1 ? fexpr__29024.cljs$core$IFn$_invoke$arity$1(G__29025) : fexpr__29024.call(null,G__29025));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29023_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__29023_SHARP_,options);
}),cljs.core.rest(form))));
}));
