...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20970 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20970(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_20971 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_20971(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_20977 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_20977(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_20979 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_20979(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21008 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21008(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21018 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21018(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__20925,callback){
var map__20926 = p__20925;
var map__20926__$1 = cljs.core.__destructure_map(map__20926);
var input = map__20926__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20926__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20926__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
