...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_48225 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_48225(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_48226 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_48226(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_48227 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_48227(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_48228 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_48228(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_48229 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_48229(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_48230 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_48230(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_48231 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_48231(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_48232 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_48232(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_48233 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_48233(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_48234 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_48234(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48212,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48212,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48217){
var vec__48218 = p__48217;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48218,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48218,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48211){
var self__ = this;
var G__48211__$1 = this;
return (new cljs.core.RecordIter((0),G__48211__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48213,other48214){
var self__ = this;
var this48213__$1 = this;
return (((!((other48214 == null)))) && ((this48213__$1.constructor === other48214.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48213__$1.status,other48214.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48213__$1.body,other48214.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48213__$1.status_text,other48214.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48213__$1.headers,other48214.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48213__$1.was_aborted,other48214.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48213__$1.__extmap,other48214.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48211){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__48221 = cljs.core.keyword_identical_QMARK_;
var expr__48222 = k__4388__auto__;
if(cljs.core.truth_((pred__48221.cljs$core$IFn$_invoke$arity$2 ? pred__48221.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__48222) : pred__48221.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__48222)))){
return (new ajax.protocols.Response(G__48211,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48221.cljs$core$IFn$_invoke$arity$2 ? pred__48221.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__48222) : pred__48221.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__48222)))){
return (new ajax.protocols.Response(self__.status,G__48211,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48221.cljs$core$IFn$_invoke$arity$2 ? pred__48221.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__48222) : pred__48221.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__48222)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__48211,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48221.cljs$core$IFn$_invoke$arity$2 ? pred__48221.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__48222) : pred__48221.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__48222)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__48211,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48221.cljs$core$IFn$_invoke$arity$2 ? pred__48221.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__48222) : pred__48221.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__48222)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__48211,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48211),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48211){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__48211,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__48215){
var extmap__4419__auto__ = (function (){var G__48224 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48215,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__48215),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__48215),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__48215),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__48215),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__48215),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
