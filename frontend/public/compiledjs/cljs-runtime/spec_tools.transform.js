...
if((x instanceof cljs.core.Keyword)){
var G__31042 = spec;
var G__31043 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31042,G__31043) : f.call(null,G__31042,G__31043));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__31045 = spec;
var G__31046 = spec_tools.transform.keyword__GT_string(spec,x);
...
if(typeof x === 'number'){
var G__31048 = spec;
var G__31049 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31048,G__31049) : f.call(null,G__31048,G__31049));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__31062,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31063__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__31065,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31066__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__31068,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31069__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
