...
var G__43775 = o;
goog.object.set(G__43775,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__43821.cljs$lang$applyTo = (function (arglist__43825){
...
var G__43778 = o;
goog.object.set(G__43778,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43828__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43829__i < G__43829__a.length) {G__43829__a[G__43829__i] = arguments[G__43829__i + 0]; ++G__43829__i;}
  args = new cljs.core.IndexedSeq(G__43829__a,0,null);
} 
return G__43828__delegate.call(this,args);};
...
return G__43828__delegate(args);
});
...
var G__43780 = props;
var G__43780__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43780,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43780);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43780__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__43780__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43785 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43785,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43785;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__43787){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43788__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__43793_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__43793_SHARP_);
}));
} else {
return null;
}
...
var vec__43795 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43795,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43795,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43795,(2),null);
...
var temp__5739__auto___43837 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___43837 == null)){
} else {
var key_43838 = temp__5739__auto___43837;
(jsprops.key = key_43838);
}
...
var temp__5739__auto___43844 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___43844 == null)){
} else {
var key_43849 = temp__5739__auto___43844;
(jsprops.key = key_43849);
}
...
var G__43799 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__43799) : reagent.impl.template.as_element.call(null,G__43799));
} else {
var temp__5739__auto___43868 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___43868 == null)){
} else {
var key_43869 = temp__5739__auto___43868;
(jsprops.key = key_43869);
}
...
var G__43805 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__43805)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__43805)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq43806){
var G__43807 = cljs.core.first(seq43806);
var seq43806__$1 = cljs.core.next(seq43806);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43807,seq43806__$1);
}));
...
break;
default:
var G__43879 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__43879;
continue;
...
var ctx = ({});
var vec__43815 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43815,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43815,(1),null);
...
var G__43818 = (cljs.core.count(argv) - first_child);
switch (G__43818) {
case (0):
