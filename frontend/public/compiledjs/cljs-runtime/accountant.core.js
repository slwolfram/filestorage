...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4115__auto__ = (function (){var fexpr__35156 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__35156.cljs$core$IFn$_invoke$arity$1 ? fexpr__35156.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__35156.call(null,link_target));
})();
if(cljs.core.truth_(and__4115__auto__)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__35157){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35158__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35158__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35158__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__35160 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__35161 = null;
var count__35162 = (0);
var i__35163 = (0);
while(true){
if((i__35163 < count__35162)){
var key = chunk__35161.cljs$core$IIndexed$_nth$arity$2(null,i__35163);
...
var G__35172 = seq__35160;
var G__35173 = chunk__35161;
var G__35174 = count__35162;
var G__35175 = (i__35163 + (1));
seq__35160 = G__35172;
chunk__35161 = G__35173;
count__35162 = G__35174;
i__35163 = G__35175;
continue;
} else {
...
var G__35176 = cljs.core.chunk_rest(seq__35160__$1);
var G__35177 = c__4556__auto__;
var G__35178 = cljs.core.count(c__4556__auto__);
var G__35179 = (0);
seq__35160 = G__35176;
chunk__35161 = G__35177;
count__35162 = G__35178;
i__35163 = G__35179;
continue;
} else {
var key = cljs.core.first(seq__35160__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__35180 = cljs.core.next(seq__35160__$1);
var G__35181 = null;
var G__35182 = (0);
var G__35183 = (0);
seq__35160 = G__35180;
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35164_SHARP_){
return cljs.core.name(p1__35164_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35165_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__35165_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__35168 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__35168) : accountant.core.nav_handler.call(null,G__35168));
} else {
