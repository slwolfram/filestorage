...
var fexpr__30978 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__30978.cljs$core$IFn$_invoke$arity$1 ? fexpr__30978.cljs$core$IFn$_invoke$arity$1(type) : fexpr__30978.call(null,type));
});
...
var G__30986 = spec_tools.impl.normalize_symbol(x);
var G__30987 = null;
var G__30988 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__30986,G__30987,G__30988) : spec_tools.parse.parse_form.call(null,G__30986,G__30987,G__30988));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__30989 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__30990 = x;
var G__30991 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__30989,G__30990,G__30991) : spec_tools.parse.parse_form.call(null,G__30989,G__30990,G__30991));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__31040 = cljs.spec.alpha.form(x);
var G__31041 = options;
x = G__31040;
options = G__31041;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__30992 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__30993 = null;
var G__30994 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__30992,G__30993,G__30994) : spec_tools.parse.parse_form.call(null,G__30992,G__30993,G__30994));
} else {
...
var G__30998 = parse_data;
var G__30998__$1 = (((G__30998 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__30998));
var G__30998__$2 = (((G__30998__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__30998__$1));
var G__30998__$3 = (((G__30998__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__30998__$2));
var G__30998__$4 = (((G__30998__$3 == null))?null:cljs.core.seq(G__30998__$3));
if((G__30998__$4 == null)){
return null;
} else {
return cljs.core.set(G__30998__$4);
}
}
});
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__30999 = cljs.core.get_global_hierarchy;
return (fexpr__30999.cljs$core$IFn$_invoke$arity$0 ? fexpr__30999.cljs$core$IFn$_invoke$arity$0() : fexpr__30999.call(null));
})());
...
var map__31000 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31000__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31000__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31000__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31000__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31000__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__31002 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__31002__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31002,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__31002);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31002__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__31002__$1;
}
}));
...
var vec__31003 = multi_spec_form;
...
var _ = first__31005;
var first__31005__$1 = cljs.core.first(seq__31004__$1);
var seq__31004__$2 = cljs.core.next(seq__31004__$1);
var multi_method_symbol = first__31005__$1;
var ___$1 = seq__31004__$2;
var form = vec__31003;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__31006){
var vec__31007 = p__31006;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31007,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__31010_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__31010_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__31011_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__31011_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__31018_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__31018_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31019_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__31019_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__31022 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31022__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__31024 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31024__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__31026,options){
var vec__31027 = p__31026;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__31031,options){
...
var ___$1 = first__31034;
var values = seq__31033__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__31030_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__31030_SHARP_,options);
}),values);
...
var type_priority = (function (p1__31035_SHARP_){
var G__31038 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__31037 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__31035_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31036_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__31036_SHARP_,options);
}),cljs.core.rest(form))));
}));
