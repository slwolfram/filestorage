...
var G__32696 = (root.arr[(slc - (1))]);
var G__32697 = (shift - (5));
var G__32698 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__32696;
shift = G__32697;
cnt = G__32698;
continue;
...
if((!(r_QMARK_))){
var rngs_32707 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_32708 = (rngs_32707[(0)]);
var new_rngs_32709 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_32710 = (rngs_32707[(32)]);
cljs.core.array_copy(rngs_32707,(1),new_rngs_32709,(0),(lim_32710 - (1)));

var i_32711 = (0);
while(true){
if((i_32711 < lim_32710)){
(new_rngs_32709[i_32711] = ((new_rngs_32709[i_32711]) - rng0_32708));

var G__32712 = (i_32711 + (1));
i_32711 = G__32712;
continue;
} else {
}
...
(new_rngs_32709[(32)] = ((rngs_32707[(32)]) - (1)));

(new_rngs_32709[((rngs_32707[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_32709);
} else {
}
...
while(true){
if((i_32713 <= li)){
(new_rngs[i_32713] = ((new_rngs[(i_32713 - (1))]) + step));

var G__32714 = (i_32713 + (1));
i_32713 = G__32714;
continue;
} else {
}
...
while(true){
if((i_32716 <= li)){
(new_rngs[i_32716] = ((rngs[i_32716]) - d));

var G__32717 = (i_32716 + (1));
i_32716 = G__32717;
continue;
} else {
}
...
while(true){
if((j_32719 <= i)){
(rngs[j_32719] = r_32720);

var G__32722 = (j_32719 + (1));
var G__32723 = (r_32720 + step);
j_32719 = G__32722;
r_32720 = G__32723;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__32689 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__32689[(0)] = node.arr.length);
...
var arr_32725__$1 = arr;
var shift_32726__$1 = shift;
while(true){
if((shift_32726__$1 === (5))){
if((!(reg_QMARK_))){
(arr_32725__$1[(32)] = rngs);
} else {
}

(arr_32725__$1[(0)] = node);
} else {
var a_32727 = (new Array(len));
var e_32728 = cljs.core.__GT_VectorNode(null,a_32727);
(arr_32725__$1[(0)] = e_32728);
...
var G__32729 = a_32727;
var G__32730 = (shift_32726__$1 - (5));
arr_32725__$1 = G__32729;
shift_32726__$1 = G__32730;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__32690 = (arr[(li - (1))]);
var G__32691 = (shift - (5));
var G__32692 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__32693 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__32690,G__32691,G__32692,G__32693) : clojure.core.rrb_vector.nodes.fold_tail.call(null,G__32690,G__32691,G__32692,G__32693));
})());
