...
return [(function (){var pred__43945 = cljs.core.instance_QMARK_;
var expr__43946 = reactive_val;
if(cljs.core.truth_((pred__43945.cljs$core$IFn$_invoke$arity$2 ? pred__43945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__43946) : pred__43945.call(null,reagent.ratom.RAtom,expr__43946)))){
return "ra";
} else {
if(cljs.core.truth_((pred__43945.cljs$core$IFn$_invoke$arity$2 ? pred__43945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__43946) : pred__43945.call(null,reagent.ratom.RCursor,expr__43946)))){
return "rc";
} else {
if(cljs.core.truth_((pred__43945.cljs$core$IFn$_invoke$arity$2 ? pred__43945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__43946) : pred__43945.call(null,reagent.ratom.Reaction,expr__43946)))){
return "rx";
} else {
if(cljs.core.truth_((pred__43945.cljs$core$IFn$_invoke$arity$2 ? pred__43945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__43946) : pred__43945.call(null,reagent.ratom.Track,expr__43946)))){
return "tr";
} else {
return "other";
}
