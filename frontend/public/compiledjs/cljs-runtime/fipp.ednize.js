...
var fipp$ednize$IEdn$_edn$dyn_32671 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_32671(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function fipp$ednize$edn_$_iter__32662(s__32663){
return (new cljs.core.LazySeq(null,(function (){
var s__32663__$1 = s__32663;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__32663__$1);
if(temp__5735__auto__){
var s__32663__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32663__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__32663__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__32665 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__32664 = (0);
while(true){
if((i__32664 < size__4528__auto__)){
var k = cljs.core._nth(c__4527__auto__,i__32664);
cljs.core.chunk_append(b__32665,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__32672 = (i__32664 + (1));
i__32664 = G__32672;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32665),fipp$ednize$edn_$_iter__32662(cljs.core.chunk_rest(s__32663__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32665),null);
}
} else {
var k = cljs.core.first(s__32663__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__32662(cljs.core.rest(s__32663__$2)));
}
} else {
return null;
}
