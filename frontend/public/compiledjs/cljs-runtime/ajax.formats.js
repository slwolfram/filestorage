...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__48476){
...
var request = map__48477__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48477__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__48481 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__48481.cljs$core$IFn$_invoke$arity$1 ? fexpr__48481.cljs$core$IFn$_invoke$arity$1(response) : fexpr__48481.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__48482 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__48482.cljs$core$IFn$_invoke$arity$1 ? fexpr__48482.cljs$core$IFn$_invoke$arity$1(response) : fexpr__48482.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__48483){
...
var request = map__48484__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48484__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
