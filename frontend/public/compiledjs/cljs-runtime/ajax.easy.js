...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__48517 = cljs.core.second(format);
var G__48518 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__48517,G__48518) : ajax.easy.keyword_response_format_element.call(null,G__48517,G__48518));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48520_SHARP_){
return ajax.easy.keyword_response_format_element(p1__48520_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__48521){
var map__48522 = p__48521;
var map__48522__$1 = (((((!((map__48522 == null))))?(((((map__48522.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48522.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48522):map__48522);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48522__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48522__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48522__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__48524){
var vec__48525 = p__48524;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48525,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48525,(1),null);
var fexpr__48528_48535 = (cljs.core.truth_(ok)?h:e);
(fexpr__48528_48535.cljs$core$IFn$_invoke$arity$1 ? fexpr__48528_48535.cljs$core$IFn$_invoke$arity$1(result) : fexpr__48528_48535.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__48529){
...
var opts = map__48530__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48530__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48530__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48530__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48530__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48530__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
