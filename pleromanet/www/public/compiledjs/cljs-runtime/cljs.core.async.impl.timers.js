...
var i_16922 = (self__.level + (1));
while(true){
if((i_16922 <= (new_level + (1)))){
(update[i_16922] = self__.header);

var G__16925 = (i_16922 + (1));
i_16922 = G__16925;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16928 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16928[i]));
} else {
x__$2.forward.push((((i < links_16928.length))?(links_16928[i]):null));
}

if((i < links_16928.length)){
(links_16928[i] = x__$2);
} else {
links_16928.push(x__$2);
}
...
var i_16932 = (0);
while(true){
if((i_16932 <= self__.level)){
var links_16933 = (update[i_16932]).forward;
if((x__$1 === (((i_16932 < links_16933.length))?(links_16933[i_16932]):null))){
(links_16933[i_16932] = (x__$1.forward[i_16932]));

var G__16934 = (i_16932 + (1));
i_16932 = G__16934;
continue;
} else {
var G__16935 = (i_16932 + (1));
i_16932 = G__16935;
continue;
}
} else {
...
var G__16942 = nx;
var G__16943 = (level__$1 - (1));
x = G__16942;
level__$1 = G__16943;
continue;
} else {
var G__16944 = x;
var G__16945 = (level__$1 - (1));
x = G__16944;
level__$1 = G__16945;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__16949 = nx;
var G__16950 = (level__$1 - (1));
x = G__16949;
level__$1 = G__16950;
continue;
} else {
var G__16951 = x;
var G__16952 = (level__$1 - (1));
x = G__16951;
level__$1 = G__16952;
continue;
}
