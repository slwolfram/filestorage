...
if((x instanceof cljs.core.Keyword)){
var G__30122 = spec;
var G__30123 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__30124 = spec;
var G__30125 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30124,G__30125) : f.call(null,G__30124,G__30125));
} else {
return x;
...
if(typeof x === 'number'){
var G__30127 = spec;
var G__30128 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__30127,G__30128) : f.call(null,G__30127,G__30128));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e30136){if((e30136 instanceof Error)){
var ___$1 = e30136;
return x;
} else {
throw e30136;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__30140,x){
var map__30141 = p__30140;
var map__30141__$1 = cljs.core.__destructure_map(map__30141);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30141__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__30142,x){
var map__30143 = p__30142;
var map__30143__$1 = cljs.core.__destructure_map(map__30143);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30143__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__30144,x){
var map__30145 = p__30144;
var map__30145__$1 = cljs.core.__destructure_map(map__30145);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30145__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
