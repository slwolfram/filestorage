...
var fexpr__29919 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__29919.cljs$core$IFn$_invoke$arity$1 ? fexpr__29919.cljs$core$IFn$_invoke$arity$1(type) : fexpr__29919.call(null,type));
});
...
var G__29927 = spec_tools.impl.normalize_symbol(x);
var G__29928 = null;
var G__29929 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__29927,G__29928,G__29929) : spec_tools.parse.parse_form.call(null,G__29927,G__29928,G__29929));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__29930 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__29931 = x;
var G__29932 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__29930,G__29931,G__29932) : spec_tools.parse.parse_form.call(null,G__29930,G__29931,G__29932));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__30118 = cljs.spec.alpha.form(x);
...
var G__29933 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__29934 = null;
var G__29935 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__29933,G__29934,G__29935) : spec_tools.parse.parse_form.call(null,G__29933,G__29934,G__29935));
} else {
...
var G__29959 = parse_data;
var G__29959__$1 = (((G__29959 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__29959));
var G__29959__$2 = (((G__29959__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__29959__$1));
var G__29959__$3 = (((G__29959__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__29959__$2));
var G__29959__$4 = (((G__29959__$3 == null))?null:cljs.core.seq(G__29959__$3));
if((G__29959__$4 == null)){
return null;
} else {
return cljs.core.set(G__29959__$4);
}
}
});
...
var map__29999 = spec_tools.impl.parse_keys(form);
var map__29999__$1 = cljs.core.__destructure_map(map__29999);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29999__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29999__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29999__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29999__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29999__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__30000 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__30000__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30000,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__30000);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30000__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__30000__$1;
}
}));
...
var vec__30013 = multi_spec_form;
...
var multi_method_symbol = first__30015__$1;
var ___$1 = seq__30014__$2;
var form = vec__30013;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__30028){
var vec__30034 = p__30028;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30034,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30034,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__30037_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__30037_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__30040_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__30040_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__30041_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__30041_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30042_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__30042_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__30068 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__30068__$1 = cljs.core.__destructure_map(map__30068);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30068__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__30069 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__30069__$1 = cljs.core.__destructure_map(map__30069);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30069__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__30070,options){
var vec__30071 = p__30070;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30071,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30071,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30071,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__30077,options){
var vec__30078 = p__30077;
var seq__30079 = cljs.core.seq(vec__30078);
var first__30080 = cljs.core.first(seq__30079);
var seq__30079__$1 = cljs.core.next(seq__30079);
var ___$1 = first__30080;
var values = seq__30079__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__30076_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__30076_SHARP_,options);
}),values);
...
var type_priority = (function (p1__30085_SHARP_){
var G__30092 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__30091 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__30085_SHARP_);
return (fexpr__30091.cljs$core$IFn$_invoke$arity$1 ? fexpr__30091.cljs$core$IFn$_invoke$arity$1(G__30092) : fexpr__30091.call(null,G__30092));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30086_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__30086_SHARP_,options);
}),cljs.core.rest(form))));
}));
