...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_31585 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_31585(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_31586 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_31586(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_31587 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_31587(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_31588 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_31588(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_31589 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_31589(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_31590 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_31590(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_31591 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_31591(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_31592 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_31592(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_31593 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_31593(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_31594 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_31594(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k31558,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k31558,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__31576){
var vec__31577 = p__31576;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31577,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31577,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__31557){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this31559,other31560){
var self__ = this;
var this31559__$1 = this;
return (((!((other31560 == null)))) && ((((this31559__$1.constructor === other31560.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31559__$1.status,other31560.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31559__$1.body,other31560.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31559__$1.status_text,other31560.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31559__$1.headers,other31560.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31559__$1.was_aborted,other31560.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31559__$1.__extmap,other31560.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k31558){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k31558);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__31557){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__31581 = cljs.core.keyword_identical_QMARK_;
var expr__31582 = k__5352__auto__;
if(cljs.core.truth_((pred__31581.cljs$core$IFn$_invoke$arity$2 ? pred__31581.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__31582) : pred__31581.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__31582)))){
return (new ajax.protocols.Response(G__31557,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31581.cljs$core$IFn$_invoke$arity$2 ? pred__31581.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__31582) : pred__31581.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__31582)))){
return (new ajax.protocols.Response(self__.status,G__31557,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31581.cljs$core$IFn$_invoke$arity$2 ? pred__31581.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31582) : pred__31581.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31582)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__31557,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31581.cljs$core$IFn$_invoke$arity$2 ? pred__31581.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31582) : pred__31581.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31582)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__31557,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31581.cljs$core$IFn$_invoke$arity$2 ? pred__31581.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31582) : pred__31581.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31582)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__31557,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__31557),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__31557){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__31557,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__31561){
var extmap__5385__auto__ = (function (){var G__31584 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__31561,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__31561)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__31584);
} else {
return G__31584;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__31561),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__31561),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__31561),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__31561),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__31561),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
