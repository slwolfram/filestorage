...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21170 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21170(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_21171 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_21171(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_21172 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_21172(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_21173 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_21173(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21174 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21174(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21178 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21178(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__21167,callback){
var map__21168 = p__21167;
var map__21168__$1 = cljs.core.__destructure_map(map__21168);
var input = map__21168__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21168__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21168__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
