...
var fipp$ednize$IEdn$_edn$dyn_32046 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_32046(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5523__auto__ = (function fipp$ednize$edn_$_iter__32039(s__32040){
return (new cljs.core.LazySeq(null,(function (){
var s__32040__$1 = s__32040;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__32040__$1);
if(temp__5804__auto__){
var s__32040__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32040__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__32040__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__32042 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__32041 = (0);
while(true){
if((i__32041 < size__5522__auto__)){
var k = cljs.core._nth(c__5521__auto__,i__32041);
cljs.core.chunk_append(b__32042,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__32047 = (i__32041 + (1));
i__32041 = G__32047;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32042),fipp$ednize$edn_$_iter__32039(cljs.core.chunk_rest(s__32040__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32042),null);
}
} else {
var k = cljs.core.first(s__32040__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__32039(cljs.core.rest(s__32040__$2)));
}
} else {
return null;
}
