...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__31857 = cljs.core.second(format);
var G__31858 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__31857,G__31858) : ajax.easy.keyword_response_format_element.call(null,G__31857,G__31858));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__31859 = format;
var G__31859__$1 = (((G__31859 instanceof cljs.core.Keyword))?G__31859.fqn:null);
switch (G__31859__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31866_SHARP_){
return ajax.easy.keyword_response_format_element(p1__31866_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__31872){
var map__31873 = p__31872;
var map__31873__$1 = cljs.core.__destructure_map(map__31873);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31873__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31873__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31873__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__31874){
var vec__31875 = p__31874;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31875,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31875,(1),null);
var fexpr__31878_31896 = (cljs.core.truth_(ok)?h:e);
(fexpr__31878_31896.cljs$core$IFn$_invoke$arity$1 ? fexpr__31878_31896.cljs$core$IFn$_invoke$arity$1(result) : fexpr__31878_31896.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__31881){
var map__31882 = p__31881;
var map__31882__$1 = cljs.core.__destructure_map(map__31882);
var opts = map__31882__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31882__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31882__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31882__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31882__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31882__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
