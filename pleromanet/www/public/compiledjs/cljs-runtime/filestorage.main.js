...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(in_focus,cljs.core.not);
}),type,id,"form-control",(function (p1__19658_SHARP_){
return cljs.core.reset_BANG_(value,p1__19658_SHARP_.target.value);
}),""])], null);
});
/**
...
return cljs.core.not((function (){var G__19660 = cljs.core.deref(password);
var fexpr__19659 = new cljs.core.Keyword(null,"check-fn","check-fn",-1710398015).cljs$core$IFn$_invoke$arity$1(req);
return (fexpr__19659.cljs$core$IFn$_invoke$arity$1 ? fexpr__19659.cljs$core$IFn$_invoke$arity$1(G__19660) : fexpr__19659.call(null,G__19660));
})());
...
var data_19666 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"email","email",1415816706),email_address,new cljs.core.Keyword(null,"password","password",417022471),password], null);
ajax.core.POST.cljs$core$IFn$_invoke$arity$variadic("http://localhost:5050/api/register",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"json","json",1279968570),new cljs.core.Keyword(null,"params","params",710516235),data_19666,new cljs.core.Keyword(null,"handler","handler",-195596612),(function (r){
...
var fexpr__19661 = cljs.core.List.EMPTY;
return (fexpr__19661.cljs$core$IFn$_invoke$arity$0 ? fexpr__19661.cljs$core$IFn$_invoke$arity$0() : fexpr__19661.call(null));
...
if(cljs.core.truth_(filestorage.main.valid_email_QMARK_(email_address))){
if(cljs.core.truth_(filestorage.main.valid_password_QMARK_(password))){
var data_19667 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"email","email",1415816706),email_address,new cljs.core.Keyword(null,"password","password",417022471),password], null);
ajax.core.POST.cljs$core$IFn$_invoke$arity$variadic("http://localhost:5050/api/login",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"json","json",1279968570),new cljs.core.Keyword(null,"params","params",710516235),data_19667,new cljs.core.Keyword(null,"handler","handler",-195596612),(function (r){
...
var el_19668 = document.getElementById(input_id);
var name_19669 = el_19668.name;
var file_19670 = (el_19668.files[(0)]);
var form_19671 = document.getElementById("upload-form");
var form_data_19672 = (new FormData());
var __19673 = form_data_19672.append("file",file_19670);
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",el_19668.value)))){
ajax.core.POST.cljs$core$IFn$_invoke$arity$variadic("http://localhost:5050/api/files/upload",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.PersistentArrayMap(null, 1, ["Authorization",["Bearer ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(filestorage.db.app_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user","user",1532431356),"token","access_token"], null)))].join('')], null),new cljs.core.Keyword(null,"body","body",-2049205669),form_data_19672,new cljs.core.Keyword(null,"handler","handler",-195596612),(function (r){
return console.log(r,cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(filestorage.db.app_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user","user",1532431356),"files"], null),cljs.core.conj,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([r], 0)),cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(filestorage.db.app_state,cljs.core.update,new cljs.core.Keyword(null,"files","files",-472457450),cljs.core.conj,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([r], 0)),cljs.core.reset_BANG_(errors,""),form_19671.reset());
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (r){
return console.log(r,((cljs.core.contains_QMARK_(r,new cljs.core.Keyword(null,"response","response",-1068424192)))?cljs.core.reset_BANG_(errors,cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(r,new cljs.core.Keyword(null,"response","response",-1068424192)),"detail")):((cljs.core.contains_QMARK_(r,new cljs.core.Keyword(null,"status-text","status-text",-1834235478)))?cljs.core.reset_BANG_(errors,cljs.core.get.cljs$core$IFn$_invoke$arity$2(r,new cljs.core.Keyword(null,"status-text","status-text",-1834235478))):null)));
})], null)], 0));
} else {
...
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.cntnr","div.cntnr",-1450244708),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),"errors",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"red"], null)], null),cljs.core.deref(errors)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),"upload-form",new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (e){
return filestorage.main.submit_file(input_id,errors,e);
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"file",new cljs.core.Keyword(null,"name","name",1843675177),"file",new cljs.core.Keyword(null,"id","id",-1388402092),input_id,new cljs.core.Keyword(null,"enc-type","enc-type",-1746291599),"multipart/form-data"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),"file type: "], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),"access level: "], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.display-image","div.display-image",816542142),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"height","height",1025178622),"300px",new cljs.core.Keyword(null,"width","width",-384071477),"300px",new cljs.core.Keyword(null,"style","style",-496642736),bg_image_style()], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),"Submit"], null)], null)], null);
});
});
/**
 * an image-selection element that shows the image you've chosen.
...
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.cntnr","div.cntnr",-1450244708),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"file-grid"], null),(function (){var iter__5523__auto__ = (function filestorage$main$file_viewer_$_iter__19662(s__19663){
return (new cljs.core.LazySeq(null,(function (){
var s__19663__$1 = s__19663;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__19663__$1);
if(temp__5804__auto__){
var s__19663__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__19663__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__19663__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__19665 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__19664 = (0);
while(true){
if((i__19664 < size__5522__auto__)){
var file_row = cljs.core._nth(c__5521__auto__,i__19664);
cljs.core.chunk_append(b__19665,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["http://localhost:5050/api/files/download/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(file_row,"filepath")),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(filestorage.db.app_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user","user",1532431356),"token","access_token"], null)))].join('')], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(file_row,"filename")], null)], null)], null));

var G__19674 = (i__19664 + (1));
i__19664 = G__19674;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19665),filestorage$main$file_viewer_$_iter__19662(cljs.core.chunk_rest(s__19663__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19665),null);
}
} else {
var file_row = cljs.core.first(s__19663__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["http://localhost:5050/api/files/download/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(file_row,"filepath")),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(filestorage.db.app_state),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user","user",1532431356),"token","access_token"], null)))].join('')], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(file_row,"filename")], null)], null)], null),filestorage$main$file_viewer_$_iter__19662(cljs.core.rest(s__19663__$2)));
}
} else {
return null;
}
